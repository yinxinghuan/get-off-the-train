...
const zh = {
  ...
  miss: '错过站！', missCopy: '车门关上了。今天的考勤要解释一下。', doorsClosed: '车门关闭', retry: '再挤一次',
...
const en: typeof zh = {
  ...
  miss: 'MISSED IT!', missCopy: 'The doors closed. Your attendance needs a story.', doorsClosed: 'DOORS CLOSED', retry: 'TRY AGAIN',
