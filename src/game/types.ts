...
export const LEVELS: LevelConfig[] = [
  { name: '普通早班', subtitle: '先学会在人缝里侧身', time: 28, passengers: 18, swayPeriod: 6.8, warning: 1.15, impulse: 2.0, roll: 2.2, wander: 0.55, fallChance: 0.08, swayFallChance: 0.12, variant: 'commuter' },
  { name: '纵座快线', subtitle: '乘客开始横穿走道', time: 27, passengers: 20, swayPeriod: 6.1, warning: 1.0, impulse: 2.35, roll: 2.7, wander: 0.66, fallChance: 0.11, swayFallChance: 0.16, variant: 'long-seat' },
  { name: '广告包车', subtitle: '碰撞开始让人失衡', time: 26, passengers: 22, swayPeriod: 5.5, warning: 0.85, impulse: 2.7, roll: 3.2, wander: 0.78, fallChance: 0.14, swayFallChance: 0.21, variant: 'ad-wrap' },
  { name: '老式窄门', subtitle: '门口横穿最频繁', time: 25, passengers: 24, swayPeriod: 4.9, warning: 0.72, impulse: 3.05, roll: 3.8, wander: 0.90, fallChance: 0.17, swayFallChance: 0.26, variant: 'narrow-door' },
  { name: '末班施工车', subtitle: '强晃动更容易摔倒', time: 24, passengers: 26, swayPeriod: 4.4, warning: 0.62, impulse: 3.4, roll: 4.4, wander: 1.0, fallChance: 0.20, swayFallChance: 0.31, variant: 'maintenance' },
]
