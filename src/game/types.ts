...
export const LEVELS: LevelConfig[] = [
  { name: '普通早班', subtitle: '先看懂人群，再找缝前进', time: 23, passengers: 9, swayPeriod: 6.8, warning: 1.15, impulse: 2.0, roll: 2.2, wander: 0.55, fallChance: 0.08, swayFallChance: 0.12, variant: 'commuter', stationEvent: 'normal', boardingCount: 0, alightingCount: 2 },
  { name: '纵座快线', subtitle: '有人下车，也有人刚上来', time: 22, passengers: 12, swayPeriod: 6.1, warning: 1.0, impulse: 2.35, roll: 2.7, wander: 0.66, fallChance: 0.11, swayFallChance: 0.16, variant: 'long-seat', stationEvent: 'normal', boardingCount: 2, alightingCount: 3 },
  { name: '广告包车', subtitle: '上下车客流开始打乱通道', time: 21, passengers: 14, swayPeriod: 5.5, warning: 0.85, impulse: 2.7, roll: 3.2, wander: 0.78, fallChance: 0.14, swayFallChance: 0.21, variant: 'ad-wrap', stationEvent: 'normal', boardingCount: 1, alightingCount: 4 },
  { name: '老式窄门', subtitle: '门口横穿最频繁', time: 20, passengers: 16, swayPeriod: 4.9, warning: 0.72, impulse: 3.05, roll: 3.8, wander: 0.90, fallChance: 0.17, swayFallChance: 0.26, variant: 'narrow-door', stationEvent: 'normal', boardingCount: 3, alightingCount: 5 },
  { name: '末班施工车', subtitle: '强晃动更容易摔倒', time: 19, passengers: 18, swayPeriod: 4.4, warning: 0.62, impulse: 3.4, roll: 4.4, wander: 1.0, fallChance: 0.20, swayFallChance: 0.31, variant: 'maintenance', stationEvent: 'normal', boardingCount: 2, alightingCount: 6 },
]
...
export function getLevelConfig(index: number): LevelConfig {
  ...
  const config: LevelConfig = {
    ...
    time: stationEvent === 'all-exit' ? 23 : stationEvent !== 'normal' ? 22 : Math.max(15, 19 - Math.floor(extra / 5) * 0.5),
