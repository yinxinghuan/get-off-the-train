...
- Car 01 is the tutorial car: holding forward follows the exit, and the clock still leaves room for a couple of falls. Cars 02–05 add people and shorten the clock (12, 12, 11, 11, 10 seconds). Door steer fades by about a tenth each car. Car 06 onward keeps stepping the same way, one second and a few riders at a time. A clear saves the highest car finished (`get-off-the-train.cg.best-clear`). The result card shows that ladder, the coins just earned, and the three upgrades.
