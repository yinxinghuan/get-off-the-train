...
- `src/game/models.ts`：角色色盘与材质、几何图元、人物比例、地面锚点 / 髋部 / 上身 rig、上臂—前臂—手掌与大腿—小腿分段骨架、乘客外形 roster。
