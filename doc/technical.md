...
- `src/game/models.ts`：角色色盘与材质、几何图元、人物比例、地面锚点 / 髋部 / 上身 / 四肢分层 rig、外描边标记与乘客外形 roster。
